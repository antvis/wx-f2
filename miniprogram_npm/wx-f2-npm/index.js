    ...
    init: function init(callback) {
      ...
      query.select('.f2-canvas').boundingClientRect(function (res) {
        if (typeof callback === 'function') {
          _this.chart = callback(_f2.default, canvas, res.width, res.height);
        } else if (_this.data.opts && _this.data.opts.onInit) {
          _this.chart = _this.data.opts.onInit(_f2.default, canvas, res.width, res.height);
        }
      }).exec();
    },
...
var _EventEmitterMin = __webpack_require__(2);
...
var Renderer = function (_EventEmitter) {
  ...
  Renderer.prototype._initContext = function _initContext(wxCtx) {
