...
var Theme = __webpack_require__(27);
...
var Path = function (_Geom) {
  ...
  Path.prototype.draw = function draw(data, shapeFactory) {
    ...
    Util.each(splitArray, function (subData, splitedIndex) {
      ...
      cfg.points = subData;
      var gShape = shapeFactory.drawShape(cfg.shape, cfg, container);
      if (gShape) {
        Util.each([].concat(gShape), function (s) {
...
Core.version = '3.1.3-beta.1';
Core.Global = __webpack_require__(1);
Core.Chart = __webpack_require__(29);
...
F2.Plugin = {
  ...
  Guide: __webpack_require__(83),
  Legend: __webpack_require__(84)
};
...
var Animator = function () {
  ...
  Animator.prototype.to = function to() {
    ...
    var easing = Easing[cfg.easing] || Easing.linear;
